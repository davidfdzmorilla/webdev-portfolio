...
- ✍️ **Rich Text Editor**: TipTap WYSIWYG with formatting, images, links
- 💬 **Nested Comments**: 1-level deep threading with real-time updates
- 😊 **Emoji Reactions**: 👍❤️🔥👏 on posts and comments
- 📡 **RSS Feeds**: Site-wide, per-category, per-author
- 🖼️ **Image Uploads**: MinIO S3-compatible storage
- 🗂️ **Categories**: Organize posts by topic
- 🔍 **SEO Optimized**: Open Graph, JSON-LD, meta tags
